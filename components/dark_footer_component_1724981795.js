            ...
            <div id="footer-logo-copyright" class="mb-4 sm:mb-0">
              <div class="mb-4">
                ...
                <a
                  ...
                  class="inline-flex"
                  href="index.html"
                  aria-label="© 2023 CyberNinja Supplies. All rights reserved."
                >
              ...
              <div id="footer-copyright" class="text-sm text-slate-400">
                ...
                <span class="text-slate-500">-</span> DDDDDDDDDDDDDDDDDDDDDDDDDDD
            </div>
            <!-- Social links -->
...
<script>
export default {
  name: "dark_footer_component_1724981795",
  data() {
    return {
      expanded: false,
      tab: null,
